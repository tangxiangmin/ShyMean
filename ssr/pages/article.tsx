...
const ArticleDetail = connect((state) => {
    ...
    return (<article class="article article-detail">
        ...
        <div class="article_nav">
            {
                prev && <Link href={`/article/${prev.title}`} class="hover-highlight article_prev">{prev.title}</Link>
            }
            {
                next && <Link href={`/article/${next.title}`} class="hover-highlight article_next">{next.title}</Link>
            }
        </div>
    </article>)
})
