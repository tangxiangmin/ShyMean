...
<style lang="scss" rel="stylesheet/scss">
   ...
   $indexcolor: ($labcolor $blogcolor $bookcolor $infocolor);
   ...
   %hover-scale {
       ...
       &:hover {
           ...
           @include box-shadow(0 0 4px 4px rgba(0,0,0,0.1));
       }
   }
   ...
   .nav-square {
       ...
       .nav_item {
           padding: 15px;
           &:hover {
               @each $color in $indexcolor{
                   &:nth-of-type(#{index($indexcolor,$color)}){
                       color: $color;
                   }
               }
           }
